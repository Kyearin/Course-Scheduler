 ...
 * @author kzy51
 */
public final class CourseSchedulerGUI extends javax.swing.JFrame {
    ...
    private void displayScheduleButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_displayScheduleButtonActionPerformed
        ...
        String student_ID = students.get(DisplayScheduleStudentComboBox.getSelectedIndex()).getStudentID();
        
        
        ArrayList<ScheduleEntry> schedule = ScheduleQueries.getScheduleByStudent(currentSemester, student_ID);
        for(ScheduleEntry entry: schedule) 
        {
            ...
            scheduleTable.addRow(new Object[] {entry.getCourse_Code(), status});
        }
    ...
    private void scheduleCourseSubmitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_scheduleCourseSubmitButtonActionPerformed
        // TODO add your handling code here:
        ArrayList<StudentEntry> students = StudentQueries.getAllStudents();
        String student_ID = students.get(selectStudentComboBox.getSelectedIndex()).getStudentID();
    ...
    private void StudentDropCourseButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_StudentDropCourseButtonActionPerformed
        ...
        ArrayList<StudentEntry> students = StudentQueries.getAllStudents();
        String studentID = students.get((int)currentStudentComboBox.getSelectedIndex()).getStudentID();
        ...
        if (!waitlisted.isEmpty()) {
            StudentEntry student = StudentQueries.getStudent(waitlisted.get(0).getStudent_ID());
            StudentDropCourseTextArea.append(student.getLastName() + ", " + student.getFirstName() + " " + "has been scheduled into" + " " + courseCode + "\n"); 
            ScheduleQueries.updateScheduleEntry(studentID, waitlisted.get(0));
        }
    ...
    private void AdminDropStudentButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AdminDropStudentButtonActionPerformed
        ...
        String firstName = StudentQueries.getFirstName(studentID);
        String lastName = StudentQueries.getLastName(studentID);
        studentDropped = studentDropped + lastName + ", " + firstName + ", " + studentID + ", " + "has been dropped from the list of all students\n";
        AdminDropStudentTextArea.setText(studentDropped);
        ...
        for (int i=0; i < semester.size();i++){
            ...
            for (int j=0; j< semesterCount.get(i); j++){
                studentDropped = studentDropped + lastName + ", " + firstName + ", " + studentID + ", " + "has been dropped from " + courseCodeByStudent.get(count) + "\n";
                count ++;
            }
        }
    ...
    private void AdminDropCourseButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AdminDropCourseButtonActionPerformed
        ...
        String scheduledDropped = "Scheduled students dropped from the course: \n";
